...
pub const LANGUAGE_SWITCHING_MIGRATION_SQL: &str =
    include_str!("migrations/040_language_switching.sql");
...
pub fn migrations() -> Vec<tauri_plugin_sql::Migration> {
    vec![
        ...
        tauri_plugin_sql::Migration {
            version: 40,
            description: "add_language_switching",
            sql: LANGUAGE_SWITCHING_MIGRATION_SQL,
            kind: tauri_plugin_sql::MigrationKind::Up,
        },
    ]
}
